...
- [ ]  **레벨 시스템:** `level` 변수를 만들어서, 6번을 누를 때마다 레벨도 1씩 올려보세요.
- [ ]  **함수 활용:** 포션을 충전하는 기능을 별도의 함수로 분리해 보세요.
- [ ]  **스탯 정보 추가1 :** 5번 선택으로 현재 능력치 출력 시, 현재 레벨도 함께 보여주세요.
